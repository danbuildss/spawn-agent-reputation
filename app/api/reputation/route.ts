...
function calculateReputation(pair: any, contractAge?: number): ReputationScore {
  ...
  // Creator History (0-10 points) - Would need indexing
  // Default to moderate score
  breakdown.creatorHistory = { score: 5, max: 10, detail: 'Not indexed yet' }
...
export async function GET(request: Request) {
  ...
  try {
    ...
    const reputation = calculateReputation(pair)
